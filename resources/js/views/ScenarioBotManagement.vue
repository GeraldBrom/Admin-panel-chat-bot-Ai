        ...
        <div class="scenario-section">
          ...
          <div class="form-group">
            ...
            <textarea
              ...
              class="form-textarea"
              rows="5"
              placeholder="{ownernameclean}, добрый день!
        ...
        <div class="scenario-section">
          ...
          <div class="form-group">
            ...
            <input
              ...
              class="form-input"
              type="text"
              placeholder="Вы сдаете еще квартиру? Ответьте Да или Нет"
            />
          </div>
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <textarea
                ...
                class="form-textarea"
                rows="3"
                placeholder="Вы согласны работать с нами? Ответьте Да или Нет"
              />
