...
const scenarioForm = ref({
    ...
    step2_yes_response: 'Актуальная цена {price}? Ответьте Да или Нет',
    step2_no_response: 'Жаль, что вы отказались от работы с нами. Если передумаете - напишите нам!',
    
    // Шаг 3: Проверка цены
    step3_default_price: '100,000 руб',
...
Я помогу вам с арендой квартиры."
        ...
        <div class="scenario-section">
          ...
          <div class="form-group">
            ...
            <input
              v-model="scenarioForm.step3_default_price"
              class="form-input"
              type="text"
              placeholder="100,000 руб"
            />
            <small class="form-help">Эта цена будет подставляться в вопрос</small>
          </div>
