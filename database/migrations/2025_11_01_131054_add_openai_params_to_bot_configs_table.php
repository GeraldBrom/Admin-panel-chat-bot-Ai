...
return new class extends Migration
{
     ...
     * - openai_model: выбор модели GPT (gpt-4o, gpt-4o-mini, gpt-4-turbo и т.д.)
     * - openai_service_tier: уровень приоритета запросов (auto, default, flex)
     */
    public function up(): void
    {
        Schema::table('bot_configs', function (Blueprint $table) {
            $table->string('openai_model')->default('gpt-4o')->after('vector_stores')
                ->comment('Модель OpenAI: gpt-4o, gpt-4o-mini, gpt-4-turbo, и т.д.');
